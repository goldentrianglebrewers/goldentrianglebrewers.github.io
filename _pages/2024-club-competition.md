...
### Classic Style Under 5% Recipes

| <a href="{% link _pages/2024-recipes/classic-under5/evan.md %}">Evan's Klasse Bravarian</a> | <a href="{% link _pages/2024-recipes/classic-under5/eric.md %}">Eric's Belgian Single</a> | 
|  <a href="{% link _pages/2024-recipes/classic-under5/joe.md %}">Joe's Cream Ale</a> | <a href="{% link _pages/2024-recipes/classic-under5/wick.md %}">Richard D's Dry Stout</a>  |<a href="{% link _pages/2024-recipes/classic-under5/wick.md %}">Wick's Cloud Shadow</a>  |

## Classic Style Under 5% Results
